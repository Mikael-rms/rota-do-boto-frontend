            ...
            <div className="flex-1 w-full">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="font-extrabold text-[#00796b] text-xl leading-tight">xxxxxxx - Lancha</p>
                  <div className="flex items-center gap-1 text-gray-400 text-xs mt-1">
                    <span>☆ 0,0 (0)</span>
                  </div>
                  {/* Preço (nn consegui deixar ele maior) */}
                  <p className="text-gray-400 mt-3 font-bold text-sm uppercase">
                    Preço: <span className="text-[#00796b] text-xl">R$000</span>
                  </p>
                </div>

                {/* Tempo de Viagem */}
                <div className="flex flex-col justify-center sm:text-center border-x-0 sm:border-x border-gray-100">
                  <p className="text-gray-400 text-[10px] font-bold uppercase mb-1">Tempo de Viagem</p>
                  <p className="font-extrabold text-[#00796b] text-3xl">00H</p>
                </div>

                {/* Data de Partida */}
                <div className="flex flex-col justify-center sm:text-center">
                  <p className="text-gray-400 text-[10px] font-bold uppercase mb-1">Data de Partida</p>
                  <p className="font-extrabold text-[#00796b] text-lg">00/00/0000 - 00H</p>
                </div>
              ...
              <div className="flex justify-end mt-4">
                <button className="w-full sm:w-auto bg-[#56e39f] hover:bg-[#45cc8b] text-[#004d40] font-bold py-3 px-10 rounded-2xl shadow-md transition-all hover:scale-105 text-base uppercase">
                  Comprar passagem
                </button>
              </div>
            </div>
